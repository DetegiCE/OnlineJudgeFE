export const m = {
  ...
  Thanks_for_registering: '회원가입이 완료되었습니다.',
  ...
  RCaptcha: '캡챠',
  ApplyEmail: '이메일 주소',
  Send_Password_Reset_Email: '비밀번호 초기화 이메일을 전송하였습니다.',
  Your_password_has_been_reset: '비밀번호가 초기화 되었습니다.',
  // Save.vue
  Save: '저장',
  // Simditor.vue
  Uploading_is_in_progress: '현재 업로드 중입니다. 페이지를 나가시겠습니까?',
  ...
  UserHomeserSubmissions: '제출 문제',
  UserHomeScore: '점수',
  List_Solved_Problems: '해결한 문제 목록',
  UserHomeIntro: '문제를 푼 기록이 없습니다.'
}
