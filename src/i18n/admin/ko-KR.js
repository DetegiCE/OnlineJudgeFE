export const m = {
  ...
  Export_Import_Problem: '문재 가져오기/내보내기',
  Contest: '대회',
  Contest_List: '대회 목록',
  ...
  Shortcut: '바로가기',
  Footer: '바닥글',
  Allow_Register: '가입 허용',
  Submission_List_Show_All: '전체 제출 목록 보기',
  // JudgeServer.vue
